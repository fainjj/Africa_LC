...
record_mismatch <- compare_records('old_records',
                                   'new_records',
                                   'UT (Unique WOS ID)')

write_csv(record_mismatch$in_new_not_in_original, here('Outs/in_new_not_in_original.csv'))
write_csv(record_mismatch$in_original_not_in_new, here('Outs/in_original_not_in_new.csv'))
