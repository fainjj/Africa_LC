...
# This function compares old and new records from Web of Science and
# returns non-matching entries.
...
# This function compares decisions by two reviewers on each record. Output
# reflects entries agreed to be dropped, agreed to be kept, and disagreements
